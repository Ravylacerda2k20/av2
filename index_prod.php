    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                ...
                <small class="float-right"><a href="add_prod.php"> <button type="button" class="btn btn-block btn-primary">Add Produto</button></a>    </small>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    foreach($stmt->fetchAll() as $k=>$v) {
                        ...
                        echo '<td>'.$v['nome'].'</td>';
                        echo '<td>'.$v['marca'].'</td>';
                        echo '<td>'.$v['validade'].'</td>';
                        echo '<td style="text-align:center"> 
                              <a class="btn btn-primary btn-sm" href="vis_prod.php?id='.$v['id'].'"><i class="fas fa-folder"></i></a>
                              <a class="btn btn-info btn-sm" href="edt_prod.php?id='.$v['id'].'"><i class="fas fa-pencil-alt"></i></a>                            
